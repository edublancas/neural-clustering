...
Files for the presentation are here: [ipynb](notebooks/presentation/all.ipynb) and [html](notebooks/presentation/all.html) ([hosted html here](https://rawgit.com/edublancas/neural-clustering/master/notebooks/presentation/all.html))
